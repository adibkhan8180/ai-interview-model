...
export class InterviewService {
    ...
    async startInterview(companyName, jobRole, jobDescription, interviewType, domain) {
    ...
    async getNextQuestion(sessionId) {
        ...
        const initialPrompt = session.chatHistory.length === 0
        ...
        session.chatHistory.push(new AIMessage(response.answer.content));
    ...
    async getFeedback(sessionId) {
        ...
        const feedback = await this.aiService.generateFeedback(lastAnswer, chatHistory);
