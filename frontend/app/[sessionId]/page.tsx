  ...
  return (
    <div className="w-full flex-1 flex flex-col sm:block bg-[#F5F8FF] py-2 sm:pt-24 md:pt-24 px-3 xl:px-0">
      ...
      <div className=" p-1 sm:p-2 md:py-4 md:px-5 rounded-2xl bg-[#fff] flex md:hidden flex-row items-center gap-1 sm:gap-2 mb-2 h-fit">
        ...
        <Button
          className="bg-[#FF4343] w-10 sm:w-12 py-3 px-4 rounded-full cursor-pointer hover:opacity-95 h-fit"
      ...
      <div className="w-full xl:w-7xl h-full mx-auto flex flex-col md:grid-cols-[2fr_5fr] gap-2 lg:gap-4 md:grid ">
        {/* video screens */}
        <div className="flex gap-4 w-full sm:w-[80%] md:w-full h-fit mx-auto md:mx-0">
          <VideoCall />
        </div>

        {/* chat screens */}
        <div className="flex-1 md:h-[85vh] rounded-3xl overflow-hidden bg-[#FFFFFF] border sborder-[#E2E8F0] flex flex-col pb-2 sm:pb-0">
